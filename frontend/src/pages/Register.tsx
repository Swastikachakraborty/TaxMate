...
export default function Register() {
  return (
    <div className="min-h-screen bg-[#faf7f2] flex flex-col items-center justify-center px-5 relative overflow-hidden">
      ...
      <div className="absolute bottom-0 right-0 w-80 h-80 bg-[#d97706]/5 rounded-full translate-y-1/3 translate-x-1/3 pointer-events-none" />
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-[#8c8577] mt-1.5">Free for India's gig workers.</p>
        </div>
